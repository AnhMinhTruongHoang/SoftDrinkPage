...
type PageDocumentDataSlicesSlice = CarouselSlice | SkyDiveSlice | FizziSlice;
 ...
 */
export interface FizziSliceDefaultPrimary {
  /**
   * Heading field in *Hero → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: fizzi.default.primary.heading
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  heading: prismic.RichTextField;
   ...
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: fizzi.default.primary.subheading
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
   ...
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: fizzi.default.primary.body
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: fizzi.default.primary.button_text
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
   ...
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: fizzi.default.primary.button_link
   ...
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: fizzi.default.primary.cans_image
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
   ...
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: fizzi.default.primary.second_heading
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type FizziSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<FizziSliceDefaultPrimary>,
  never
>;
 ...
 */
type FizziSliceVariation = FizziSliceDefault;
